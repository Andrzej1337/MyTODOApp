...
@AndroidEntryPoint
class TasksFragment : Fragment(R.layout.fragment_tasks), TasksAdapter.OnItemCilkListener {
            ...
            viewModel.tasksEvent.collect { event ->
                when (event){
                    is TasksViewModel.TasksEvent.ShowUndoDeleteTaskMessage ->{
                        Snackbar.make(requireView(), "zadanie zrobione " , Snackbar.LENGTH_LONG)
                            .setAction("Cofnij"){
                    ...
                    is TasksViewModel.TasksEvent.ShowTaskSavedConfirmnationMessage ->
                        Snackbar.make(requireView(),event.mgs,Snackbar.LENGTH_SHORT).show()
    ...
    override fun onIntemClick(task: Task) {
